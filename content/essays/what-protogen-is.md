...
Protogen is a training program I created at Slalom to bring designers into the agentic era. Not by lecturing them about AI, but by putting them in front of the material and letting them build. The core insight was simple: designers don't learn by reading about new tools. They learn by making things. So we built Protogen around making things.

A typical session looks like this. A room full of designers — none of whom would call themselves developers. We open VS Code. We open Claude Code. And we start building. In an hour, people have made real, working applications. A Pokédex. A personal data management tool. A native mobile prototype. Things that work. Things they can show. The absorption in the room is total. Not because the technology is exciting — though it is — but because designers are finally touching the material. They're not describing what they want. They're not mocking up an approximation. They're shaping the actual thing, and they can feel the difference immediately.

But Protogen isn't just about building things. It's about training designers on three fundamental shifts in how design work happens when AI is in the loop.

The first is the research shift. Design research has always been constrained by time and resources. How many interviews can you do? How much data can you synthesize? With agentic AI, the constraint changes. A designer can synthesize thousands of support tickets in minutes. They can identify patterns across datasets that would take weeks to process manually. The research doesn't become less rigorous — it becomes more comprehensive, faster. But you have to learn how to direct that capability. What questions to ask. How to validate what comes back. That's a new skill.

The second is the making shift. This is the most visible change. Designers who've spent their careers in Figma, Sketch, and presentation tools can now build functional prototypes — real ones, not clickable mockups — in the time it used to take to set up an artboard. The prototype is the product, or close enough that the gap between concept and reality shrinks to almost nothing. But working in code requires different instincts than working in design tools. You have to learn to think in systems, to debug with intent, to iterate on the real thing instead of a representation of the thing.

The third is the collaboration shift. When designers can build, the relationship with engineering changes fundamentally. You're not handing off specs. You're not arguing about feasibility in a sprint planning meeting. You're sitting side by side, working in the same material, making decisions together in real time. That requires a different kind of conversation — more technical fluency from designers, more design fluency from engineers, and a shared vocabulary that didn't exist before.
